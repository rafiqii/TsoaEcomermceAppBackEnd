...
function findCat(product, categories) {
    return __awaiter(this, void 0, void 0, function () {
        var i, myCategory, newCategory;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, category_1.Category.findOne({ categoryName: categories[i] })];
                case 2:
                    myCategory = _a.sent();
                    if (!!myCategory) return [3 /*break*/, 4];
                ...
                case 6:
                    ;
                    return [2 /*return*/, product.categories];
            }
        });
    });
}
